...
/**
 * Represents a 9 character account number with validation logic
 */
public class AccountNumber {
	...
	/**
	 * @return sum of each numeric value in the account number multiplied by 
	 * 9 - its position (with the string indexed 1 - 9) - see unit tests for example 
	 */
